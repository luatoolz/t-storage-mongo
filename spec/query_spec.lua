describe("query", function()
  ...
  it("unquery #array", function()
    assert.same({'a', {limit=1}, true}, pak(unquery({'a', {limit=1}, true})))
    assert.same({'a', {limit=2}, 'function'}, pak(unquery({'a', {limit=1}, true}, {limit=2}, 'function')))
  end)
